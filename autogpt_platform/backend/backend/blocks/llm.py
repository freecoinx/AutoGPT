...
class LlmModel(str, Enum, metaclass=LlmModelMeta):
    ...
    OLLAMA_DEEPSEEK_V3_7B = "deepseek-v3"
    OLLAMA_DEEPSEEK_R1_7B = "deepseek-r1"
    # OpenRouter models
...
MODEL_METADATA = {
    ...
    LlmModel.OLLAMA_DEEPSEEK_V3_7B: ModelMetadata("ollama", 8192),
    LlmModel.OLLAMA_DEEPSEEK_R1_7B: ModelMetadata("ollama", 8192),
